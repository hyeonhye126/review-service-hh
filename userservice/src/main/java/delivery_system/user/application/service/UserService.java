...
public class UserService {
    ...
    public void signup(String userId, String rawPassword, String rawAddress, String role) {
        ...
        userEntity.setRole(UserRole.valueOf(role.toUpperCase()));
        // ✅ 비밀번호 암호화는 도메인 메서드에서 한 번만 수행
        userEntity.signup(rawPassword, passwordEncoder);
        userEntity.setCreated_by(userId); // "생성한 사람"을 자기 자신의 ID로 설정
    ...
    public TokenResponse login(String userId, String rawPassword) {
        ...
        String accessToken = jwtUtil.generateAccessToken(userEntity.getUserId(), userEntity.getRole());
